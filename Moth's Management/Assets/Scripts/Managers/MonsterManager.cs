...
public class MonsterManager : MonoBehaviour
{
    ...
    void SpawnFromDens()
    {
        ...
        List<Tile> dens = GetAllTilesOfType(TileType.MonsterDen);
 
        foreach (Tile den in dens)
        {
            if (Random.value >= GameConstants.MonsterSpawnChance) continue;
    ...
    List<Tile> GetAllTilesOfType(TileType type)
    {
